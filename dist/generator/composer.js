...
function addRootTemplates(config, templates) {
    const rootTemplates = [
    ...
    if (config.needsGoWork) {
        rootTemplates.push({ templatePath: 'root/go.work.hbs', outputPath: 'go.work' }, { templatePath: 'root/.golangci.yml.hbs', outputPath: '.golangci.yml' }, { templatePath: 'root/Makefile.hbs', outputPath: 'Makefile' });
    }
    if (config.hasFrontend) {
        rootTemplates.push({ templatePath: 'packages/design-tokens/package.json.hbs', outputPath: 'packages/design-tokens/package.json' }, { templatePath: 'packages/design-tokens/tokens.css.hbs', outputPath: 'packages/design-tokens/tokens.css' }, { templatePath: 'packages/design-tokens/motion.ts.hbs', outputPath: 'packages/design-tokens/motion.ts' }, { templatePath: 'packages/design-tokens/index.ts.hbs', outputPath: 'packages/design-tokens/index.ts' }, { templatePath: 'packages/ui/package.json.hbs', outputPath: 'packages/ui/package.json' }, { templatePath: 'packages/ui/src/primitives/cn.ts.hbs', outputPath: 'packages/ui/src/primitives/cn.ts' }, { templatePath: 'packages/ui/src/primitives/motion-config.ts.hbs', outputPath: 'packages/ui/src/primitives/motion-config.ts' }, { templatePath: 'packages/ui/src/component-meta.ts.hbs', outputPath: 'packages/ui/src/component-meta.ts' }, { templatePath: 'packages/types/src/index.ts.hbs', outputPath: 'packages/types/src/index.ts' }, { templatePath: 'packages/ui/src/button/button.tsx.hbs', outputPath: 'packages/ui/src/button/button.tsx' }, { templatePath: 'packages/ui/src/button/index.ts.hbs', outputPath: 'packages/ui/src/button/index.ts' }, { templatePath: 'packages/ui/src/card/card.tsx.hbs', outputPath: 'packages/ui/src/card/card.tsx' }, { templatePath: 'packages/ui/src/card/index.ts.hbs', outputPath: 'packages/ui/src/card/index.ts' }, { templatePath: 'packages/ui/src/input/input.tsx.hbs', outputPath: 'packages/ui/src/input/input.tsx' }, { templatePath: 'packages/ui/src/input/index.ts.hbs', outputPath: 'packages/ui/src/input/index.ts' }, { templatePath: 'packages/ui/src/badge/badge.tsx.hbs', outputPath: 'packages/ui/src/badge/badge.tsx' }, { templatePath: 'packages/ui/src/badge/index.ts.hbs', outputPath: 'packages/ui/src/badge/index.ts' }, { templatePath: 'packages/ui/src/index.ts.hbs', outputPath: 'packages/ui/src/index.ts' }, { templatePath: 'packages/ui/code-connect.ts.hbs', outputPath: 'packages/ui/code-connect.ts' });
    }
    if (config.needsDocker) {
        rootTemplates.push({ templatePath: 'infra/docker/docker-compose.yml.hbs', outputPath: 'infra/docker/docker-compose.yml' });
    }
    rootTemplates.push({ templatePath: 'docs/adr/0001-initial-architecture.md.hbs', outputPath: 'docs/adr/0001-initial-architecture.md' }, { templatePath: 'docs/README.md.hbs', outputPath: 'docs/README.md' });
    rootTemplates.push({ templatePath: 'infra/github-actions/ci.yml.hbs', outputPath: '.github/workflows/ci.yml' });
    for (const tmpl of rootTemplates) {
        templates.push(resolveTemplate(tmpl, {}, config));
    }
}
function addClaudeBaseArtifacts(config, artifacts, seen) {
    const baseArtifacts = [
    ...
    if (config.hasFrontend) {
        baseArtifacts.push({ type: 'rule', templatePath: 'claude/rules/design-system.md.hbs', outputPath: '.claude/rules/design-system.md' }, { type: 'agent', templatePath: 'claude/agents/design-reviewer.md.hbs', outputPath: '.claude/agents/design-reviewer.md' }, { type: 'skill', templatePath: 'claude/skills/design-review/SKILL.md.hbs', outputPath: '.claude/skills/design-review/SKILL.md' }, { type: 'skill', templatePath: 'claude/skills/figma-sync/SKILL.md.hbs', outputPath: '.claude/skills/figma-sync/SKILL.md' }, { type: 'skill', templatePath: 'claude/skills/figma-implement/SKILL.md.hbs', outputPath: '.claude/skills/figma-implement/SKILL.md' });
    }
...
function filterArtifacts(artifacts, config) {
...
function resolveTemplate(tmpl, localContext, config) {
...
function addUniqueArtifacts(newArtifacts, existing, seen) {
...
function addUniqueCiSteps(newSteps, existing) {
